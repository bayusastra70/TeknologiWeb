...
<head>
    ...
    <style>
    .bg-green-500{
        background-color:rgb(34 197 94 /var );
    }
    </style>
</head>
<body class="navbar-flash bg-green-500" data-base-url="/">
<div class="main-wrapper bg-green-500" id="app">
    ...
    <div class="page-wrapper">
        ...
        <footer class="footer border-top">
            <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between py-3 small">
                <p class="text-muted mb-1 mb-md-0">Copyright © {{now()->format('Y')}} </p>
